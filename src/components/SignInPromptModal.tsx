  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="mb-1 text-lg font-bold text-gray-900">Sign in to save your adventures</h2>
        ...
        <button
          onClick={onClose}
          className="mt-3 w-full rounded-lg px-4 py-2 text-sm text-gray-400 hover:text-gray-600 transition-colors"
        >
          Maybe later
        </button>
      </div>
